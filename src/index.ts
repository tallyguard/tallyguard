...
export { analyzeProject, analyzeProjectDetailed } from "./core/analyze.js";
export type { JsAnalysis } from "./core/analyze.js";
...
export { analyzePythonProject, analyzePythonProjectDetailed } from "./core/python/analyze.js";
export type { PyAnalysis } from "./core/python/analyze.js";
...
export { formatTerminal, formatCoverageLine } from "./report/terminal.js";
export type {
  Finding,
  RuleId,
  Severity,
